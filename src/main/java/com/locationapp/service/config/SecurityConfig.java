...
import com.locationapp.service.security.JwtAuthenticationFilter;
 ...
 * Similar to setting up authentication in Android apps.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Public read endpoints for locations
